...
median_male = all_players_new %>%
  filter(gender == 'M') 
median_male = mean(median_male$wage_eur)

median_female = all_players_new %>%
  filter(gender == 'F') 
median_female = mean(median_female$wage_eur)

paste0('Median Male Player Salary: ', median_male, 'euro')
paste0('Median Female Player Salary: ', median_female, ' euro')
...
```
The Cleveland Dot Plot above provides many interesting insights.XXX